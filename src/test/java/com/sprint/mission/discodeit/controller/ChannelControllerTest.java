...
class ChannelControllerTest {
  ...
  void createPublicChannel_Success() throws Exception {
    ...
    ChannelResponse createdChannel = new ChannelResponse(
        channelId,
        ChannelType.PUBLIC,
        "test-channel",
        "채널 설명입니다.",
  ...
  void updateChannel_Success() throws Exception {
    ...
    ChannelResponse updatedChannel = new ChannelResponse(
        channelId,
        ChannelType.PUBLIC,
        "updated-channel",
        "업데이트된 채널 설명입니다.",
  ...
  void findAllByUserId_Success() throws Exception {
    ...
    List<ChannelResponse> channels = List.of(
        ...
        new ChannelResponse(
            ...
            null,
            null,
            List.of(new UserResponse(userId, "user1", "user1@Codeit.com", null, true)),
