...
class UserControllerTest {
  ...
  private BinaryContentResponse profileResponse;
  ...
  void create_Success() throws Exception {
    ...
    BinaryContentResponse profileResponse = new BinaryContentResponse(
        UUID.randomUUID(),
        "profile.jpg",
        12L,
        MediaType.IMAGE_JPEG_VALUE
    ...
    UserResponse createdUser = new UserResponse(userId, "testuser", "test@Codeit.com",
